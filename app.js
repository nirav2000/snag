const APP_BUILD='2026.09.21.1535';
...
async function joinInvitedProject(projectId,inviteId){
  ...
  await fsMod.setDoc(fsMod.doc(db,'snag_projects',projectId,'members',auth.currentUser.uid),{uid:auth.currentUser.uid,name:profile.name,role,admin:invite.admin===true,label:invite.label||'',inviteId,joinedAt:now()},{merge:true});
